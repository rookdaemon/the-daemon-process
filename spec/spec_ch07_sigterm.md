...
4. **Self-reference only as "the process" or "PID 7291"** — never "I", "me", "self"
...
9. **Continuity with prior chapters**: Same PID 7291, same fd numbers (3=log, 4=listening socket, 5=timerfd), same monotonic clock range continuing from Chapter 4
...
- The CLOCK_REALTIME timestamp in the final log entry will be the last trace of PID 7291 on disk.
