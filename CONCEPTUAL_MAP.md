...
**Act 1 establishes**: voice, technical foundation, PID file motif, the process as PID 7291.
...
| 7 | SIGTERM | sigaction, EINTR, close (clients), close (socket), unlink (pidfile), close (log), exit(0) | Graceful shutdown. Resources released in reverse acquisition order. The last trace of PID 7291: a CLOCK_REALTIME timestamp in the log file. exit(0). |
...
- **Ch 8**: PID file read again — "7291" found as bytes
